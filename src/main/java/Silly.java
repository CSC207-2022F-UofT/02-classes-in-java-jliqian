...
public class Silly implements Comparable<Silly>{
     ...
     * This constructor takes in a single int as an argument.
     *
     * @param a a String for the first half of this Silly instance's name.
     * @param b aString for the second half of this Silly instance's name.
     */
    public Silly(String a, String b) {
        this.name = a.concat(b);
    }
